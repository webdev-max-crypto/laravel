...
<style>
    ...
    .notif-list { display: flex; flex-direction: column; gap: 10px; max-width: 720px; }
    ...
    .notif-card.unread .notif-message { color: var(--ink); }
    ...
    .empty-state {
        ...
        color: var(--slate); max-width: 400px; margin: 0 auto;
    }
...
@forelse($notifications as $notif)
    ...
    <div class="notif-card {{ $notif->is_read ? '' : 'unread' }}">
        ...
        <div class="notif-body">
            ...
            @if(!$notif->is_read)
                <a href="{{ route('customer.notifications.read', $notif->id) }}" class="btn-mark-read">
                    Mark as Read
                </a>
            @endif
        </div>
