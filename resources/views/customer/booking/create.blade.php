...
@endif
        ...
        <form action="{{ route('customer.booking.store', $warehouse->id) }}" method="POST" style="margin-top:25px;">
            ...
            <a href="{{ route('customer.warehouses.book', $warehouse->id) }}" class="btn btn-primary" style="padding:12px 20px;background:#16a34a;color:white;border:none;border-radius:6px;font-weight:600;cursor:pointer;transition:0.3s;text-decoration:none;">Book Warehouse</a>
        </form>
