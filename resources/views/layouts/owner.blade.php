...
<div class="sidebar">
    ...
    <div class="sidebar-user">
        ...
        <div>
            ...
            <div class="user-role">Warehouse Owner</div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('owner.warehouses.index') }}" class="nav-item {{ request()->routeIs('owner.warehouses.*') ? 'active' : '' }}">
            <span class="nav-icon">🏢</span> My Warehouses
        </a>
        ...
        <a href="{{ route('owner.balances') }}" class="nav-item {{ request()->routeIs('owner.balances') ? 'active' : '' }}">
            <span class="nav-icon">💰</span> Balance
        </a>

        <div class="nav-label" style="margin-top:6px;">Support</div>

        <a href="{{ route('owner.notifications.index') }}" class="nav-item {{ request()->routeIs('owner.notifications.*') ? 'active' : '' }}">
...
<div class="topbar">
    <div class="topbar-left">
        <span class="page-title">Owner Panel</span>
    </div>
        ...
        <div class="notif-wrapper">
            ...
            <div class="notif-dropdown" id="notifDropdown">
                ...
                <div class="notif-footer">
                    <a href="{{ route('owner.notifications.index') }}">View All →</a>
                </div>
            </div>
        </div>

        <a href="{{ route('owner.profile') }}" class="profile-chip">
